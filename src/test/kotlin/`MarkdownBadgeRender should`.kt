...
class `MarkdownBadgeRender should`: StringSpec({
    ...
    "generate a markdown for a successful `BuildSummary` without build scan URL." {
        ...
        actualMarkdown shouldBe """
            [](123456789)![](https://img.shields.io/badge/✔_root--project_-:build-0A0?&style=flat-square) ![](https://img.shields.io/badge/8.12.1-555?&style=flat-square&logo=Gradle)  
		""".trimIndent()
    }
    ...
    "generate a markdown for a failed `BuildSummary` without build scan URL." {
        ...
        //language=Markdown
        actualMarkdown shouldBe """
            [](123456789)![](https://img.shields.io/badge/✖_another--root--project_-:check--all-F55?&style=flat-square) ![](https://img.shields.io/badge/8.12.1--rc2-555?&style=flat-square&logo=Gradle)  
		""".trimIndent()
    }
    ...
    "generate a markdown for a successful `BuildSummary` with build scan URL." {
        ...
        //language=Markdown
        actualMarkdown shouldBe """
            [](123456789)![](https://img.shields.io/badge/✔_project_-:build-0A0?&style=flat-square) [![](https://img.shields.io/badge/8.12-BuildScan-06A0CE?&style=flat-square&logo=Gradle)](test://buildscan)  
		""".trimIndent()
    }
    ...
    "generate a markdown for a successful `BuildSummary` failing to publish build scan URL." {
        ...
        //language=Markdown
        actualMarkdown shouldBe """
            [](123456789)![](https://img.shields.io/badge/✔_root--project_-:build-0A0?&style=flat-square) ![](https://img.shields.io/badge/8.9-BuildScan_failed-F55?&style=flat-square&logo=Gradle)  
		""".trimIndent()
    }
    ...
    "generate a markdown for a successful `BuildSummary` with multiple tasks." {
        ...
        //language=Markdown
        actualMarkdown shouldBe """
            [](123456789)![](https://img.shields.io/badge/✔_root--project_-:clean_:check_:build-0A0?&style=flat-square) ![](https://img.shields.io/badge/8.12.1-555?&style=flat-square&logo=Gradle)  
		""".trimIndent()
    }
